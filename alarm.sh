...
if [ "$Weekend" = "False" ]; then
    case "$NowTime" in
            "0600")
                /usr/bin/mplayer -noconsolecontrols -ao pulse -volume 100 -really-quiet "/home/steven/documents/background_tunes/relax/01-simon slator-antarctica.mp3" &
                echo $! >/tmp/alarm_1.pid
            ;;
            "0545") 
                /home/steven/scripts/briefing.sh
                /usr/bin/mplayer -noconsolecontrols -ao pulse -volume 100 -really-quiet -playlist "/home/steven/briefing/play.m3u" &
                echo $! >/tmp/alarm_2.pid
            ;;
            "0650")     
                /usr/bin/mplayer -noconsolecontrols -ao pulse -volume 100 -really-quiet -loop 5 "/home/steven/music/the essential nilsson/01-harry nilsson-gotta get up.mp3" &
                echo $! >/tmp/alarm_3.pid
            ;;
            "0655") 
                /usr/bin/mplayer -noconsolecontrols -ao pulse -volume 100 -really-quiet -loop 5 "/home/steven/music/goru bihu song/rainbow trip-goru bihu song.mp3" &
